...
export const metadata: Metadata = {
  ...
  description: 'Free CLAP and VST3 plugins for music makers and engineers. Weft for spectral processing, Wow for pitch modulation, and Inton for MTS-ESP tuning.',
